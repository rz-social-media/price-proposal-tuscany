...
const translations = {
  en: {
    ...
    days: [
      ...
      { date: "Friday · October 9", title: "Fire, flour & celebration" },
  ...
  it: {
    ...
    days: [
      ...
      { date: "Venerdì · 9 ottobre", title: "Fuoco, farina e festa" },
  ...
  es: {
    ...
    days: [
      ...
      { date: "Viernes · 9 de octubre", title: "Fuego, harina y celebración" },
